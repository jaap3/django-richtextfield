...
class TestRichTextWidget(TestCase):
    ...
    def test_css_class_addition(self):
        ...
        self.assertEqual(widget.attrs["class"], "somethingelse djrichtextfield")
...
class SettingsTestCase(TestCase):
    ...
    def test_render(self):
        ...
        expected = (
            '<div class="{0}">'
            '<textarea class="djrichtextfield" cols="40" name="" rows="10">\r\n</textarea>'
    ...
    def test_render_with_settings(self):
        ...
        expected = (
            '<div class="{0}">'
            '<textarea class="djrichtextfield" cols="40" data-field-settings="{1}" name="" rows="10">\r\n</textarea>'
